...
extern "C" {
    ...
    UNK CATH_DSP_INSTRUCTION_DISASM(const SH_DSP_INSTRUCTION*, char*, UNK);
    UNK CATH_DSP_INSTRUCTION_DISASM_OPERAND(const SH_DSP_INSTRUCTION*, char*, UNK);
    ...
    static const SH_DSP_D_OP_ENTRY CATH_DSP_YA_OP_TABLE[] =
    {
        ...
        { .OP_MASK = 0x03, .OP_PATTERN = 0x03, .MNEMONIC = "MOV", .DEST_NAME = "A",  .SOURCE = DSP_OPERAND_X    },
        { .OP_MASK = 0x00, .OP_PATTERN = 0x00, .MNEMONIC = NULL,  .DEST_NAME = NULL,  .SOURCE = DSP_OPERAND_NONE },
    };
