...
static const SH_ENTRY SH2_DECODE_TABLE[CATH_INSTR_ID_ALL_MAX] =
{
    ...
    { 0xF00F, 0x4029, CATH_INSTR_ID_STSMACL },
    { 0xF00F, 0x000A, CATH_INSTR_ID_STSMACH },
    { 0xF00F, 0x001A, CATH_INSTR_ID_STSPR },
    { 0xF00F, 0x0002, CATH_INSTR_ID_STCSR },
    { 0xF00F, 0x0012, CATH_INSTR_ID_STCGBR },
    { 0xF00F, 0x0022, CATH_INSTR_ID_STCVBR },
    ...
    { 0xF0FF, 0x4008, CATH_INSTR_ID_SHLL },
    { 0xF0FF, 0x4009, CATH_INSTR_ID_SHLR },
    { 0xF0FF, 0x4018, CATH_INSTR_ID_SHLL },
    { 0xF0FF, 0x4019, CATH_INSTR_ID_SHLR },
    { 0xF0FF, 0x4028, CATH_INSTR_ID_SHLL },
    { 0xF0FF, 0x4029, CATH_INSTR_ID_SHLR },
...
static CATH_INSTR_ID CATH_INSTRUCTION_PROCESS_UNIQUE_ID(const SH_INSTRUCTION* INSTR)
{
    ...
    {
        if((WORD & ENTRY->MASK) == ENTRY->PATTERN) return ENTRY->ID;
    }
...
void CATH_INSTRUCTION_PROCESS(SH_INSTRUCTION* INSTR)
{
    ...
    {
        INSTR->DESCRIPTOR = &INSTR_DESCRIPTORS[CATH_INSTR_ID_INVALID];
    }
}