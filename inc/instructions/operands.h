...
#include "instructions/instruction.h"
    ...
    UNK CATH_OPERAND_TYPE_GET_BUFFER_SIZE(SH_OPERAND_TYPE, const SH_INSTRUCTION*);
    ...
    UNK CATH_OPERAND_TYPE_AT_RM_POST_INC(const SH_INSTRUCTION*, char*, UNK);
    ...
    UNK CATH_OPERAND_TYPE_AT_R0_RM(const SH_INSTRUCTION*, char*, UNK);
    UNK CATH_OPERAND_TYPE_AT_DISP_GBR(const SH_INSTRUCTION*, char*, UNK);
    UNK CATH_OPERAND_TYPE_AT_RN_PC(const SH_INSTRUCTION*, char*, UNK);
