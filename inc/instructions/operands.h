...
#include <common.h>
    ...
    UNK CATH_OPERAND_TYPE_AT_DISP_RN(const struct SH_INSTRUCTION* INSTR, char* BUFFER, UNK SIZE);
    UNK CATH_OPERAND_TYPE_AT_DISP_RM(const struct SH_INSTRUCTION* INSTR, char* BUFFER, UNK SIZE);
