...
extern "C" {
    ...
    static const SH_DSP_D_OP_ENTRY CATH_DSP_X_OP_TABLE[] =
    {
        ...
        { .OP_MASK = 0x07, .OP_PATTERN = 0x01, .MNEMONIC = "MOV", .DEST_NAME = "X",   .SOURCE = DSP_OPERAND_X   },
    ...
    {
        { .OP_MASK = 0x07, .OP_PATTERN = 0x00, .MNEMONIC = NULL,  .DEST_NAME = NULL,  .SOURCE = DSP_OPERAND_NONE },
        { .OP_MASK = 0x07, .OP_PATTERN = 0x01, .MNEMONIC = "MOV", .DEST_NAME = "Y",   .SOURCE = DSP_OPERAND_Y   },
        { .OP_MASK = 0x07, .OP_PATTERN = 0x02, .MNEMONIC = "CLR", .DEST_NAME = "A",   .SOURCE = DSP_OPERAND_NONE },
        { .OP_MASK = 0x07, .OP_PATTERN = 0x03, .MNEMONIC = "MOV", .DEST_NAME = "A",   .SOURCE = DSP_OPERAND_ALU  },
        { .OP_MASK = 0x07, .OP_PATTERN = 0x04, .MNEMONIC = "MOV", .DEST_NAME = "A",   .SOURCE = DSP_OPERAND_Y   },
        { .OP_MASK = 0x00, .OP_PATTERN = 0x00, .MNEMONIC = NULL,  .DEST_NAME = NULL,  .SOURCE = DSP_OPERAND_NONE },
    };
